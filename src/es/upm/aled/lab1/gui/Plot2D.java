...
public final class Plot2D {
	...
	private CompositionPlot2D container;
	private JLabel draw;
	...
	public void setContainer(CompositionPlot2D container) {
		this.container = container;
	}

	public CompositionPlot2D getContainer() {
		return container;
	}
	...
	/**
	 * Set the window size to w-by-h pixels. Throws a
	...
	private Image getImage(String filename) {
		...
		if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
			URL url = Plot2D.class.getResource(filename);
			if (url == null)
